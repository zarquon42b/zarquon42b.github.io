...
Bayes <- createBayes(mymod,sdmax=c(rep(3,5),ptValueNoise = 2))# this means that the first 3 elastic iterations are restricted to be within 3 standard deviations of our model and we attribute some point noise for the landmarks
